...
const BunnyCompanion: React.FC<BunnyCompanionProps> = ({
  ...
  return <div className="bg-card border border-border rounded-2xl p-6 shadow-lg relative overflow-hidden animate-fade-in hover:shadow-xl transition-shadow duration-300">
      {/* Space stars background with enhanced animations */}
      <div className="absolute inset-0 opacity-30 bg-zinc-950">
