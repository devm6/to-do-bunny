...
const motivationalQuotes = ["You're absolutely pookie-tastic! Keep going! 💕", "My little pookie is crushing these tasks! 🥰", "Being productive never looked so pookie! ✨", "You're the most adorable task-master, pookie! 🎀", "Pookie power activated! Nothing can stop you! 💪", "Every small step counts on your journey! 🐰", "You're doing amazing, keep hopping forward!", "Believe in yourself, little bunny warrior!", "Progress, not perfection, is the goal!", "You've got this, one carrot at a time!", "Small wins lead to big victories!", "Keep bouncing back, that's your superpower!", "Your effort today creates tomorrow's success!", "Hop into your potential, you're unstoppable!", "Every task completed is a victory dance!", "Be the change you want to see in your burrow! 🏠", "The journey of a thousand hops begins with a single bounce! 🦘", "To be or not to be productive, that is the question... Choose to be! 🎭", "May the focus be with you, young padawan! ⭐", "Show me the progress! 💰", "The early bunny catches the carrot! 🌅"];
const BunnyCompanion: React.FC<BunnyCompanionProps> = ({
  ...
  return <div className="bg-gradient-to-br from-pink-900/20 via-black to-purple-900/20 border border-pink-300/30 rounded-2xl p-6 shadow-lg relative overflow-hidden animate-fade-in hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="text-center relative z-10">
        <div className="mb-3 relative">
          ...
          <div className="relative inline-block">
            ...
            animationDelay: '0.3s'
          }} className="absolute -top-2 left-1/2 transform -translate-x-1/2 text-2xl animate-bounce my-[16px]">
              🎀
            </div>
          </div>
        </div>
        ...
        {!getMoodText() && randomQuote && <div className="text-sm text-pink-200 font-medium animate-fade-in mb-2" style={{
        animationDelay: '0.5s',
        ...
        {getMoodText() && <div className="text-sm text-pink-200 font-medium animate-fade-in" style={{
        animationDelay: '0.2s',
        textShadow: '0 0 10px rgba(255, 192, 203, 0.5)'
      }}>
            {getMoodText()}
